...
var B=20
Prova();
console.log("Il valore di A="+A);

var r = prompt("Vuoi inserire un numero? S/N ")
if (r == "S")
    B=prompt("Inserisci il numero: ")

console.log("Il tipo di B è:"+typeof(B))
parola="Buonasera"
for (i=0; i<parola.length; i++)
{
    console.log("La lettere in posizione "+i+" della parola "+parola+" è: "+parola[i])
}
process.exit(0);
*/
...
for (i=0; i<P.length; i++)
{
    if (P[i]== "a" || P[i]== "e" || P[i]== "i" || P[i]== "o" || P[i]== "u")
        console.log(P[i]+" è una vocale.")
    else
        console.log(P[i]+" è una consonante.")
...
var A=prompt('Enter il valore per A: ');
var B=prompt('Enter il valore per B: ');
